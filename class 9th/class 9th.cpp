...
public:
	...
	{
		Vector2 object(this->x + clone.x, this->y + clone.y);
		return object;
...
#pragma region 연산자 오버로딩
	...
	//
	//cout << "vector3 x: " << vector3.X() << endl;
	//
	//cout << "vector3 y: " << vector3.Y() << endl; 
	//
	////cout << "vector1의 x 값: " << vector1.X()<<endl;
	////cout << "vector1의 y 값: " << vector1.Y() << endl; 
	//
	//Vector2 vector4(10, 10);
	//
	//	--vector4;
	//
	//	cout << "vector4의 값: " << vector4.X() << endl;
	//	cout << "vector4의 값: " << vector4.Y() << endl; 
	//
	//	Vector2 vector5 = vector4--;
	//	cout << "vector5의 값: " << vector4.X() << endl; 
	//	cout << "vector5의 값: " << vector4.Y() << endl;  
